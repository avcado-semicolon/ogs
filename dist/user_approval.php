...
if (isset($_POST['approved_1'])) {
    ...
    if ($result == true) {
        echo '<script>';
            echo 'Swal.fire({';
            echo '    title: "Approved!",';
            echo '    text: "Account Approved!",';
            echo '    icon: "success",';
            echo '    showConfirmButton: false';
            echo '}).then(function() {';
            echo '    window.location.href = "user_approval.php";';
            echo '});';
        echo '</script>';
    } else {
        echo '<script>';
...
if (isset($_POST['deny_1'])) {
    $id = $_POST['ID'];

    $delete = "UPDATE users SET status = 'denied' WHERE ID = '$id'";
...
if (isset($_POST['deny_2'])) {

    $id = $_POST['ID'];
    $update = "UPDATE users SET status = 'denied' WHERE ID = '$id'";
    $result = mysqli_query($conn, $update);
    ...
    <div>
        ...
        <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
            ...
            <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0">
                ...
                <a class="flex items-center px-6 py-2 mt-4 text-gray-100 bg-gray-700 bg-opacity-25" href="./user_approval.php">
            ...
            <div class="flex flex-col flex-1 overflow-hidden">
                    ...
                    <div class="flex items-center">
                        ...
                        <div x-data="{ dropdownOpen: false }" class="relative">
                            <button @click="dropdownOpen = ! dropdownOpen" class="relative block w-8 h-8 overflow-hidden rounded-full shadow focus:outline-none">
                                <img class="logo" src="/dash/dist/upload_img/<?php echo $user['image']; ?>">
                            </button>
                ...
                <!-- STUDENTS APPROVAL GRADES-->
                <main class="flex-1 overflow-x-hidden overflow-y-auto ">
                    <div class="container px-6 py-8 mx-auto">
                        <h3 class="text-3xl font-medium text-gray-700">ACCOUNT APPROVAL</h3>
                                            ...
                                            <table class="min-w-full">
                                                <thead>
                                                    <tr class="bg-gray-900 text-white">
                                                        <th class="px-4 py-3 text-sm leading-4 tracking-wider text-center">TEACHERS ID</th>
                                                ...
                                                <tbody class="bg-white ">
                                                    ...
                                                    $result_count = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users WHERE access = 'Teacher' AND status = 'pending'"));
                                                    ...
                                                    if (isset($_POST['searchbtn_1'])) {
                                                        ...
                                                        $result = mysqli_query($conn, "SELECT * FROM users WHERE access = 'Teacher' AND status = 'pending' LIMIT $offset, $total_records_per_page");
                                                    }
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="px-7 py-6 text-sm flex items-center justify-center font-bold leading-5 text-gray-800 whitespace-no-wrap border-b border-gray-200 bg-gray-100">
                                                                <img src="/dash/dist/upload_img/<?php echo $rs['image'] ?>" class=" rounded-full w-10">
                                                            </td>

                                                            <td class="px-6 py-4 text-sm text-center font-bold leading-5 text-gray-800 whitespace-no-wrap border-b border-gray-20 bg-lime-300">
                                                            ...
                                                            <td class="px-6 py-4 text-sm   text-center font-bold  text-gray-800 whitespace-no-wrap border-b border-gray-200 bg-gray-100">
                                                                <form action="user_approval.php" method="POST" class="relative flex items-center">
                                                                    <input type="hidden" name="ID" value="<?php echo $rs['ID']; ?>">
                                                                    <button type="submit" name="approved_1" value="Approve"><img src="./img/checked.png" class="w-7"></button>
                                                                    <button type="submit" name="deny_1" value="Deny"><img src="./img/x.png" class="w-7"></button>
                                                                </form>
                                                            </td>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td colspan="6" class="text-center bg-amber-300">No pending accounts found.</td>
                                                    </tr>
                                                <?php
                                                }
                                                ?>
                                ...
                                <ul class=" list-none flex flex-col sm:flex-row sm:items-center mt-4">
                                    ...
                                    <?php for ($i = 1; $i <= $total_no_of_pages; $i++) : ?>
                                        <li class="mb-2 sm:mb-0 sm:mr-2 <?= $page_no == $i ? 'active' : '' ?>">
                                            <a class="relative block rounded bg-transparent px-3 py-1.5 text-sm text-neutral-600 transition-all duration-300 dark:text-white dark:hover:bg-neutral-700 dark:hover:text-white" href="?page_no=<?= $i; ?>">
                                                <?= $i; ?>
                                            </a>
                                        </li>
                                    <?php endfor; ?>
                                        ...
                                        <div class="sm:overflow-auto border-b border-gray-200 shadow sm:rounded-lg">
                                            <table class="min-w-full">
                                                ...
                                                <tbody class="bg-white ">
                                                    <?php
                                                    $total_records_per_page = 10;
                                                    $result_count = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users  WHERE access = 'administrator' AND status = 'pending'"));
                                                    $total_no_of_pages = ceil($result_count / $total_records_per_page);
                                                    ...
                                                    if (isset($_POST['searchbtn_2'])) {
                                                        ...
                                                        $result = mysqli_query($conn, "SELECT * FROM users WHERE access = 'administrator' AND status = 'pending' LIMIT $offset, $total_records_per_page");
                                                    }
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="px-11 py-6 text-sm flex items-center justify-center font-bold leading-5 text-gray-800 whitespace-no-wrap border-b border-gray-200 bg-gray-100">
                                                                <img src="/dash/dist/upload_img/<?php echo $rs['image'] ?>" class="rounded-full-f w-10">
                                                            </td>

                                                            <td class="px-7 py-4 text-sm text-center font-bold leading-5 text-gray-800 whitespace-no-wrap border-b border-gray-20 bg-lime-300">
                                                                <?php echo $rs['Fullname'] ?>
                                                            </td>
                                                            ...
                                                            <td class="px-6 py-4 text-sm   text-center font-bold  text-gray-800 whitespace-no-wrap border-b border-gray-200 bg-gray-100">
                                                                <form action="user_approval.php" method="POST" class="relative flex items-center">
                                                                    <input type="hidden" name="ID" value="<?php echo $rs['ID']; ?>">
                                                                    <button type="submit" name="approved_2" value="Approve"><img src="./img/checked.png" class="w-7"></button>
                                                                    <button type="submit" name="deny_2" value="Deny"><img src="./img/x.png" class="w-7"></button>
                                                                </form>
                                                            </td>
