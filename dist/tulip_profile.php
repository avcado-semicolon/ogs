...
$dataObj->insertDataTulip();

$dataObj->updateTulipDataById($_POST);
...
if(isset($_GET['deleteId']) && !empty($_GET['deleteId'])) {
    ...
    $dataObj->deleteTulipProfileById($deleteId);
} 
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto ">
                <div class="container px-6 py-8 mx-auto">
                    ...
                    <div class="container mx-auto mt-8 p-4 sm:p-8 bg-white rounded-lg shadow-md">
                        ...
                        <form method="POST" action="tulip_profile.php" id="myForm" class=" max-w-6xl mx-auto" enctype="multipart/form-data">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                ...
                                <input type="file" name="picture" id="fileInput" class="w-full px-4 py-3 rounded-lg bg-blue-100 text-blue-800" required="">
                            </div>
                    ...
                    <div class="container mx-auto mt-8 p-4 sm:p-8 bg-white rounded-lg shadow-md">
                        <h2 class="text-2xl font-bold text-gray-800 mb-6">LIST OF THE STUDENT IN SECTION TULIPS</h2>
                                                    ...
                                                    <th class="px-6 py-3 text-xs leading-4 tracking-wider text-center">ACTION</th>
                                                        ...
                                                        <tbody class="bg-white ">
                                                            <?php
                                                                ...
                                                                $result_count = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM studentdata"));
                                                                ...
                                                                if(isset($_POST['searchbtn'])){
                                                                        ...
                                                                        $result = mysqli_query($conn,"SELECT * FROM studentdata WHERE 
                                                                        ID LIKE '%$keyword%' 
                                                                    ...
                                                                    if (isset($_GET['sort'])) {
                                                                        ...
                                                                        $sort_result = mysqli_query($conn, "SELECT * FROM studentdata");
                                                                        $records = [];
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="px-6 py-4 text-sm text-center leading-5 text-gray-800 whitespace-no-wrap border-b border-gray-200 bg-yellow-400">
                                                                ...
                                                                <td class="px-5 py-6 text-sm flex items-center justify-center leading-5 text-gray-800 whitespace-no-wrap border-b border-gray-200 bg-gray-100">
                                                                    <a href="../dist/grades/grades_1.php?viewGrades=<?php echo $rs['ID']?>" >
                                                                ...
                                                                <td class="px-6 py-4 text-sm leading-5 text-gray-800 whitespace-no-wrap border-b border-gray-200 bg-gray-100">
                                                                    <div class="flex items-center justify-between">
                                                                        ...
                                                                        <!-- Delete button -->
                                                                        <a href="tulip_profile.php?deleteId=<?php echo $rs['ID'];?>"
                                                                    ...
                                                                    <div  id="update_modal<?php echo $rs['ID'];?>"  class="hidden ml-[38%]  absolute md:inset-0 max-h-full">
                                                                        <div class="p-4 max-w-md max-h-full">
                                                                            ...
                                                                            <div class="pt-3 pl-8 pr-8 pb-3 bg-slate-300 rounded-lg">
                                                                                ...
                                                                                <!-- Modal body -->
                                                                                <form class="p-0 md:p-5 -mt-10" action="tulip_profile.php" method="POST">
