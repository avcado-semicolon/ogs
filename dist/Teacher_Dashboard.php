...
if(isset($_SESSION["Teacher"])) {
    $id = $_SESSION["Teacher"];
    $tulip = $dataObj->selectTulipById();
}


$tulip = $dataObj->selectTulipById();
$orchid = $dataObj->selectOrchidById();
    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
        ...
        <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0">
            ...
            <nav class="mt-10">
                ...
                <a class="flex items-center px-6 py-2 mt-4 text-gray-100 bg-gray-700 bg-opacity-25" href="./Teacher_Dashboard.php">
        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto ">
                <div class="container px-6 py-8 mx-auto">
                    <h3 class="text-3xl font-medium text-neutral-900">Teacher Dashboard</h3>
                            ...
                            <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 xl:mt-3">
                                <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                                    ...
                                    <div class="mx-5">
                                            <p class="text-2xl font-semibold text-gray-700">
                                            <?php
                                                $query = "SELECT Status FROM grading_system WHERE Status = 'approved'";
                                                $result = mysqli_query($conn, $query);
                                                $row = mysqli_num_rows($result);
                                                echo '<h1 class="text-3xl font-bold text-center">'.$row.'</h1>';
                                            ?>
                                            </p>
                                            <div class="text-gray-500 font-normal text-center">Approved Grades</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mt-8 h-[440px] bg-gradient-to-br from-pink-200 via-purple-200 to-blue-200 p-10 rounded-lg sm:overflow-auto sm:overflow-y-hidden">
                            <div class="flex flex-wrap -mx-8">
                                <div class="w-full sm:w-1/2 px-8">
                                    <div id="piechart1" class="w-[500px] h-[350]"></div>
                                </div>
                                <div class="w-full sm:w-1/2 px-8">
                    ...
                    <div class="container px-6 py-8 mx-auto">
                                ...
                                <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 sm:mt-3">
                                    <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                                        ...
                                        <div class="mx-5">
                                                <p class="text-2xl font-semibold text-gray-700">
                                                <?php
                                                    $query = "SELECT Status FROM grading_system_2 WHERE Status = 'pending'";
                                                    $result = mysqli_query($conn, $query);
                                                    $row = mysqli_num_rows($result);
                                                    echo '<h1 class="text-3xl font-bold text-center">'.$row.'</h1>';
                                                ?>
                                ...
                                <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 xl:mt-3">
                                    <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                                        ...
                                        <div class="mx-5">
                                                <p class="text-2xl font-semibold text-gray-700">
                                                <?php
                                                    $query = "SELECT Status FROM grading_system_2 WHERE Status = 'approved'";
                                                    $result = mysqli_query($conn, $query);
                                                    $row = mysqli_num_rows($result);
                                                    echo '<h1 class="text-3xl font-bold text-center">'.$row.'</h1>';
                                                ?>
                        ...
                        <div class="container px-8 py-10 mx-auto">
                            ...
                            <div class="mt-8 h-[440px] bg-gradient-to-br from-pink-200 via-purple-200 to-blue-200 p-10 rounded-lg sm:overflow-auto sm:overflow-y-hidden">
                                <div class="flex flex-wrap -mx-8">
                                    <div class="w-full sm:w-1/2 px-8">
                                        <div id="piechart3" class="w-[500px] h-[350]"></div>
                                    </div>
                                    <div class="w-full sm:w-1/2 px-8">
                                        <div id="piechart4" class="w-[500px] h-[350]"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <?php else: ?> 
                <div class="h-screen w-full flex justify-center items-center text-8xl font-extrabold">No Section Found</div>
            <?php endif; ?>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    // Check screen width and execute code if it's greater than or equal to 640px
        ...
        function drawChart() {
            ...
            var options = {
                title: 'Pie chart analysis of gender in Tulip',
                titleTextStyle: {
                    color: "#333",
                    fontName: "Arial",
                    fontSize: 20,
        ...
        function drawChart2() {
            var data = google.visualization.arrayToDataTable([
                ['Status', 'Number'],
                <?php 
                    $result = "SELECT Status, Count(*) AS number FROM grading_system GROUP BY Status";
                    $rs = mysqli_query($conn, $result);
                    while($data = mysqli_fetch_array($rs)){
                        echo "['".$data['Status']."',".$data['number']."],";
                    }
                ?>
            ]);

            var options = {
                title: 'Pie chart analysis of Approved and Pending Grades',
                titleTextStyle: {
                    color: "#333",
                    fontName: "Arial",
                    fontSize: 20,
...
<script type="text/javascript">
    // Check screen width and execute code if it's greater than or equal to 640px
        ...
        function drawChart() {
            ...
            var options = {
                title: 'Gender Pie Chart Analysis',
                titleTextStyle: {
                    color: "#333",
                    fontName: "Arial",
                    fontSize: 20,
        ...
        function drawChart2() {
            var data = google.visualization.arrayToDataTable([
                ['Status', 'Number'],
                <?php 
                    $result = "SELECT Status, Count(*) AS number FROM grading_system_2 GROUP BY Status";
                    $rs = mysqli_query($conn, $result);
                    while($data = mysqli_fetch_array($rs)){
                        echo "['".$data['Status']."',".$data['number']."],";
                    }
            ...
            var options = {
                title: 'Pie Chart Analysis of Approved, Denied, and Pending Grades',
                titleTextStyle: {
                    color: "#333",
                    fontName: "Arial",
                    fontSize: 20,
