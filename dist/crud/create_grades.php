...
$insert = $dataObj->getSingleDataCreateTulip();
$dataObj->addGradesTulip();
...
<form  method="POST" action="create_grades.php" id="myForm">
    <div class="max-w-2xl mx-auto bg-teal-200 p-6 rounded-md shadow-md mt-8">
        ...
        <button type="submit" name="add_grade" class="cursor-pointer bg-purple-500 text-white mx-2 py-2 px-4 rounded-md hover:bg-purple-600 mb-2 md:mb-0">Save</button>
            <a href="../grades/grades_1.php?viewGrades=<?php echo $personalId; ?>" class="cursor-pointer bg-indigo-500 text-white mx-2 py-2 px-4 rounded-md hover:bg-indigo-700 mb-2 md:mb-0">Back</a>
        </div>
    </form>
</body>
