...
$dataObj->updateGradesDataTulip($_POST);
?>
            ...
            <div>
                ...
                <table class="w-full border-collapse  mb-2">
                    ...
                    if(isset($_GET['updateId']) && !empty($_GET['updateId'])){
                        ...
                        $rs = $dataObj->displayGradingByDataTulip($editId);
                    } else {
                        // Handle the case when 'updateId' is not set or is empty
                        // You can display a message, redirect, or perform other actions
                        echo '<tr>
                                <td colspan="6" class="text-center">No record to display. Please provide a valid updateId.</td>
                            </tr>';
                    }
                    ?>
                    <?php if(isset($rs)) { ?>
